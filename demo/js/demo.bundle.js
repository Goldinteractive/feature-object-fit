...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(15), __webpack_require__(3), __webpack_require__(2)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
...
var noCase = __webpack_require__(17)
...
var lowerCase = __webpack_require__(16)

var NON_WORD_REGEXP = __webpack_require__(20)
var CAMEL_CASE_REGEXP = __webpack_require__(18)
var CAMEL_CASE_UPPER_REGEXP = __webpack_require__(19)
...
/* WEBPACK VAR INJECTION */(function(base) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    ...
    factory(exports, require('object-fit-images'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.objectFitImages);
    global.index = mod.exports;
  }
})(this, function (exports, _objectFitImages) {
  'use strict';
  ...
  var ObjectFitImage = function (_base$features$Featur) {
    _inherits(ObjectFitImage, _base$features$Featur);

    function ObjectFitImage() {
      _classCallCheck(this, ObjectFitImage);

      return _possibleConstructorReturn(this, (ObjectFitImage.__proto__ || Object.getPrototypeOf(ObjectFitImage)).apply(this, arguments));
    }

    _createClass(ObjectFitImage, [{
      key: 'init',
      value: function init() {
        (0, _objectFitImages2.default)(this.node, this.options);
      }
    }]);
